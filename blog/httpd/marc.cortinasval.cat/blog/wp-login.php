...
<title>One more technical blog in the net &rsaquo; Log In</title>
<script type='text/javascript'>window.mod_pagespeed_start = Number(new Date());</script><link rel='stylesheet' id='buttons-css' href='https://marc.cortinasval.cat/blog/wp-includes/css/buttons.min.css?ver=4.1.1' type='text/css' media='all'/>
...
<link rel='stylesheet' id='dashicons-css' href='https://marc.cortinasval.cat/blog/wp-includes/css/dashicons.min.css?ver=4.1.1' type='text/css' media='all'/>
<link rel='stylesheet' id='login-css' href='https://marc.cortinasval.cat/blog/wp-admin/css/login.min.css?ver=4.1.1' type='text/css' media='all'/>
...
pagespeed.addInstrumentationInit('/mod_pagespeed_beacon', 'beforeunload', '', 'http://marc.cortinasval.cat/blog/wp-login.php');
//]]></script></head>
<body class="login login-action-login wp-core-ui  locale-en-us">
<div id="login">
<h1><a href="https://wordpress.org/" title="Powered by WordPress" tabindex="-1">One more technical blog in the net</a></h1>
<form name="loginform" id="loginform" action="https://marc.cortinasval.cat/blog/wp-login.php" method="post">
<p>
...
<input type="hidden" name="redirect_to" value="https://marc.cortinasval.cat/blog/wp-admin/"/>
<input type="hidden" name="testcookie" value="1"/>
</p>
</form>
<p id="nav">
<a href="https://marc.cortinasval.cat/blog/wp-login.php?action=lostpassword" title="Password Lost and Found">Lost your password?</a>
</p>
<script>function wp_attempt_focus(){setTimeout(function(){try{d=document.getElementById('user_login');d.focus();d.select();}catch(e){}},200);}wp_attempt_focus();if(typeof wpOnload=='function')wpOnload();</script>
<p id="backtoblog"><a href="https://marc.cortinasval.cat/blog/en/" title="Are you lost?">&larr; Back to One more technical blog in the net</a></p>
</div>
<div class="clear"></div>
...
pagespeed.addInstrumentationInit('/mod_pagespeed_beacon', 'load', '', 'http://marc.cortinasval.cat/blog/wp-login.php');
//]]></script></body>
</html>
